export const groupedOfferCopy = [
  {
    ...
    data: {
      attributes: {
        ...
        display_price__limio: "<strong>€45</strong> per maand",
        display_name__limio: "Flexibele looptijd: per maandl",
        ...
        cta_text__limio: "Kies De Tijd Digitaal",
        payment_types__limio: ["zuora_paypal", "zuora_card"],
        display_description__limio: "test",
        price__limio: [
          {
            name: "charge_1",
            label: "Charge 1",
        ...
        detailed_display_price__limio:
          "<ul><li>U krijgt 4 jaar lang 50% korting</li><li>U betaalt het jaarbedrag in één keer via een online betaling via uw kredietkaart (VISA of Mastercard) of via Bancontact</li></ul>",
      ...
      products: [
        {
          ...
          attributes: {
            ...
            description__limio:
              "<p>The Economist apps&nbsp;</p><p>Economist.com</p><p>Audio edition and podcasts</p>",
          },
  ...
  },
  {
    ...
    data: {
      attributes: {
        ...
        cta_text__limio: "Kies De Tijd Digitaal + Weekend",
        display_name__limio: "Flexibele looptijd: per maand",
        offer_features__limio:
        ...
        display_description__limio: "FORMULE LA PLUS FRÉQUEMMENT CHOISIE",
        best_value__limio: true,
        price__limio: [
          {
            name: "charge_1",
        ...
        best_value__limio: true,
        display_price__limio: "€45 per maand",
        detailed_display_price__limio:
          "<ul><li>U krijgt 4 jaar lang 50% korting</li><li>U betaalt het jaarbedrag in één keer via een online betaling via uw kredietkaart (VISA of Mastercard) of via Bancontact</li></ul>",
  ...
  },
  {
    ...
    data: {
      attributes: {
        ...
        cta_text__limio: "Kies De Tijd Compleet",
        display_name__limio: "Flexibele looptijd: per maand",
        offer_features__limio:
          '<p><span style="background-color: transparent;">Daily news analysis on Economist.com</span></p><p><span style="background-color: transparent;">Enjoy the weekly full newspaper digitally</span></p><p><span style="background-color: transparent;">Stay up to date on the go with the app</span></p><p><span style="background-color: transparent;">Exclusive subscriber-only newsletters</span></p>',
        payment_types__limio: ["zuora_paypal", "zuora_card"],
